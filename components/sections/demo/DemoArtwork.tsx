...
export function DemoArtwork() {
  ...
  useEffect(() => {
    ...
    // follows the card, and the card's height changes between the idle and
    // success states while the art keeps its token height, so refresh the
  ...
  return <div ref={clipRef} className="demo-side-rail" aria-hidden="true">
    ...
    <div className="lp-cta__art lp-cta__art--right demo-side-art" {...(gl ? {} : { "data-lp-gl-off": "" })}>
