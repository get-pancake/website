...
faq:
  ...
  - question: "Which part of a zero-headcount company does Pancake handle?"
    answer: "Go-to-market. Pancake is an AI GTM team: it watches buying signals, brings you new leads each morning with the reason each was picked, and runs outreach to the ones you approve from your own account. It also writes articles built to show up in Google and AI answers, all for $99 a month flat."
---
...
[Pancake](/) is an AI GTM team that runs this loop on the professional social network instead of the inbox. It picks leads from buying signals: people posting about a topic you choose, people engaging with a competitor's posts, companies hiring for roles that match your buyer. Each lead arrives with the signal that picked it. Once you approve a lead, Pancake reaches out from your own account, and the first message asks one light question tied to the signal, so the conversation starts warm. If you're weighing that against a first sales hire, [Pancake vs hiring a BDR](/blog/pancake-vs-hiring-a-bdr) compares the cost of each.
...
**GTM agents:**  
Pancake finds your buyers from six kinds of signals, starts the conversations from your own account, and writes articles built to show up in Google and AI answers. You can run it from Claude, ChatGPT or Codex through its MCP server. It costs [$99 a month flat](/pricing), with every agent included.
...
If the first hire you're trying to avoid is someone who finds leads and starts conversations, make that the first job you hand off. [See how Pancake finds your buyers](/).
