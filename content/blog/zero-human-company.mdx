...
faq:
  ...
  - question: "What tools are used to build an autonomous company?"
    answer: "Most setups combine an orchestrator or agent runtime (Paperclip, or direct API access to a model), a shared knowledge base such as Notion, and an async channel like Slack where agents report. Specialist tools then cover single functions, such as Pancake for finding buyers and running outreach."
  - question: "Is Pancake a zero-human company platform?"
    answer: "No. Pancake is an AI GTM team for founders and small B2B companies. Its agents find people who show buying signals, run outreach from your own account and write articles for Google and AI search, while you approve the leads and the articles."
---
...
Sales prospecting shows the line well. [Pancake](/), an AI GTM team for founders and small B2B companies, puts the human checkpoint on the lead. Its agents watch for buying signals and bring you new leads each morning, each with the reason it was picked. You approve the leads you want. From there, outreach runs from your own account without a sign-off on each message.
...
Agents that do not share context make inconsistent decisions. Pancake applies this inside go-to-market with what it calls the GTM Brain, one memory of your positioning, ideal customers, offers, proof and objections. The agent that picks leads, the one that runs outreach and the one that writes articles all draw on it, so they tell the same story.
