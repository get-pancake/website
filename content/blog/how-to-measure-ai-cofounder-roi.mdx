...
## Measuring a GTM Tool Like Pancake

The five metrics work for any AI tool. If the tool you're measuring is [Pancake](/), pipeline numbers tell you more, and sooner. Pancake is an AI GTM team, not an AI co-founder: it finds people who show buying signals, runs outreach from your own account, and writes articles built to show up in Google and AI answers.

Track these each week, next to hours back:

- **Leads you approve.** New leads arrive each morning, each with the signal that picked it. The share you approve tells you whether Pancake has learned who buys from you.
...
The cost side of the formula is fixed: Pancake is [$99/month flat](/pricing), with every agent included. The 3-day free trial (card required) is long enough to judge whether the first leads look like your buyers. It is not long enough to measure ROI, so hold it to the 30-day checkpoint above.
