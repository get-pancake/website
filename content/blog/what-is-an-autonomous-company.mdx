...
faq:
  ...
  - question: "What is Pancake?"
    answer: "Pancake is an AI GTM team whose agents watch buying signals, pick the people showing them and start conversations from your own account. They also write articles built to show up in Google and AI answers, all for $99/month flat with every agent included."
---
...
[Pancake](/) runs guided autonomy for go-to-market. Its agents pick leads from buying signals and bring them to you each morning. You approve the leads and the articles, so your judgment decides who hears from you. After that one approval, Pancake runs the whole outreach sequence on its own.
...
Pancake today is an AI GTM team for founders and small B2B companies. It brings the harness described above to go-to-market, with the memory and the daily schedule already built. You add your website, and its agents go looking for your buyers.
...
- **It writes articles built to show up in Google and in AI answers.** You approve those too.
- **It works from your AI assistant.** Connect Claude, ChatGPT or Codex through Pancake's MCP server to review leads, adjust signals and start outreach from the same chat.

It costs [$99/month flat](/pricing): every agent included, no seats, no usage billing.
