...
faq:
  ...
  - question: "Is Pancake a SaaP product?"
    answer: "No. Pancake is an AI GTM team for founders and small B2B companies that finds buyers and runs outreach. You approve leads and articles, and once a lead is approved its outreach runs without a sign-off on each message."
---
...
[Pancake](/) is neither a SaaP partner nor a platform that runs your company. It is an AI GTM team for founders and small B2B companies, and it does one job: find people who show buying signals and start conversations with them.

Its approval model sits between the two columns above. You approve at two points. The first is the leads that arrive each morning, in the app or from Slack, each with the signal that explains why it was picked. The second is the articles Pancake writes for Google and AI search.

After you approve a lead, the outreach runs from your own account on the professional social network. It visits the profile, likes a recent post, sends an invite with no note, then follows with up to three messages. You don't review each message before it goes out.

That is one gate per lead instead of one gate per step. The judgment call stays with you (who is worth contacting), and the repetitive follow-through runs without adding to your approval queue. Pancake doesn't touch product, finance or operations. It costs [$99/month flat](/pricing), with a 3-day free trial.
