...
faq:
  - question: "Is Pancake a replacement for a human co-founder?"
    answer: "No. A human co-founder brings strategic vision, domain expertise and shared ownership. Pancake is an AI GTM team that handles one part of execution: finding people who show buying signals and running outreach from your own account."
  - question: "What does Pancake do compared to a human co-founder?"
    answer: "It covers prospecting. Pancake watches six kinds of buying signals, brings new leads each morning with the reason each was picked, and runs a short outreach sequence from your account. It also writes articles for Google and AI search that you approve, while strategy, fundraising, hiring and product stay with the founders."
  ...
  - question: "How much equity would I give up to a human co-founder vs. Pancake?"
    answer: "A human co-founder typically takes 20-50% equity, depending on stage and role. Pancake takes none: it costs $99 per month flat with every agent included. Lower cost doesn't make it a substitute, since a subscription can't bring the commitment a co-owner does."
  - question: "When should I choose a human co-founder over Pancake?"
    answer: "Choose a human when you need domain expertise you lack, credibility in a regulated industry, a full team for investors, or someone who debates your strategy. Pancake only helps once you know who you sell to and need more conversations with them."
---

**TL;DR:** A human co-founder brings strategic partnership, shared ownership and, sometimes, investor credibility. [Pancake](/) is an AI GTM team: its agents find people showing buying signals and run outreach from your own account. It covers one slice of execution, not the whole company. Plenty of founders will want both.
...
Pancake is a monthly subscription. Cancel and it stops at the end of the billing period. A co-founder can't walk away without consequences.
...
Pancake doesn't replace a co-founder, and it doesn't replace a whole early team. It takes one job off your list: finding buyers and starting conversations with them.
...
Pancake writes articles built to show up in Google and AI answers. It draws on what its GTM Brain knows about your positioning, buyers and proof, and you approve each article.
...
- Scope: prospecting, outreach and search articles only
...
4. **Your buyers are on the professional social network.** That's the channel Pancake works in. If your buyers only answer email or the phone, it's the wrong tool.
...
If you already have a co-founder, Pancake doesn't replace them. It takes daily prospecting off both your plates.
...
- Send email, make phone calls, or sync leads to your CRM
- Run finance, legal, hiring or customer support

It runs prospecting. It doesn't set strategy.

If you need someone to shape the company's direction, find a human. If you've set the direction and need more buyers hearing about it, use Pancake.
